...
$('form#FrmInsertPemecahan').submit(function(e){
    ...
    if(id_button == 'save'){
        ...
        var endpoint = 'insert/pemecahan';
        var myTitle = 'Insert Pemecahan';

    }else{

        var endpoint = 'insert/pemecahan/draft';
        var myTitle = 'Insert Draft Pemecahan';
