...
$('form#FrmInsertSalinan').submit(function(e){
    ...
    /*if ($('form#FrmInsertsalinan')[0].checkValidity() === false) {
        e.stopPropagation();
    } else {
        
    }

    $('#FrmInsertsalinan').addClass('was-validated');*/
    ...
    if(id_button == 'save'){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var title = 'Insert Draft Salinan';
                var message = data.message;
                var redirect = 'history';
